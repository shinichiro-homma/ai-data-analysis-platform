...
| # | タスク | ステータス | E2Eテスト | 備考 |
|---|--------|-----------|-----------|------|
| 1.1.1 | Dockerfile 作成 | [ ] | - | ベースイメージ: jupyter/scipy-notebook |
...
| # | タスク | ステータス | E2Eテスト | 備考 |
|---|--------|-----------|-----------|------|
| 2.1 | notebook_create ツール実装 | [ ] | MCPツールでノートブックファイルが作成される | |
| 2.2 | notebook_add_cell ツール実装 | [ ] | MCPツールでセルが追加される | |
| 2.3 | 結合テスト | [ ] | ノートブック作成→セル追加の一連フローが動作 | |
...
| # | タスク | ステータス | E2Eテスト | 備考 |
|---|--------|-----------|-----------|------|
| 3.1 | session_create ツール実装 | [ ] | MCPツールでセッション（カーネル）が起動する | |
| 3.2 | session_list ツール実装 | [ ] | MCPツールでセッション一覧が取得できる | |
| 3.3 | session_delete ツール実装 | [ ] | MCPツールでセッションが終了する | |
